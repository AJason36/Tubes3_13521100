  ...
  return (  
    <>
      ...
      <div className="flex flex-col items-start justify-start gap-[2vh] text-[1.5rem]">
        ...
        <div className="flex flex-col items-start w-[100%] min-h-[20vh] max-h-[40vh] justify-start gap-[1vh] text-[0.75rem] text-lightgray-200 overflow-y-auto space-y-1 scrollbar-hide">
